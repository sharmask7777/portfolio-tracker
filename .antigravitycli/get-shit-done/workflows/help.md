...
- Generates `./.antigravitycli/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.antigravitycli/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/notes/` globally)
