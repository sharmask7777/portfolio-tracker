...
```
Agent(
  prompt="Read /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/templates/VALIDATION.md`
