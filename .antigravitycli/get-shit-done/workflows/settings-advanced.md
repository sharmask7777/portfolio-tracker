...
gsd-sdk query config-set model_profile_overrides.antigravitycli.opus gemini-3-ultra
gsd-sdk query config-set model_profile_overrides.antigravitycli.haiku null
```
