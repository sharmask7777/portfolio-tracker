...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.antigravitycli/skills/sketch-findings-[project]/`
...
3. Check if `./.antigravitycli/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.antigravitycli/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.antigravitycli/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.antigravitycli/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.antigravitycli/skills/` with SKILL.md, references/, sources/
