...
<required_reading>
@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/user-story-template.md
@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/spidr-splitting.md
@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/spidr-splitting.md`. Briefly:
