...
<required_reading>
@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/ai-frameworks.md
@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/agents/gsd-eval-planner.md for instructions.
