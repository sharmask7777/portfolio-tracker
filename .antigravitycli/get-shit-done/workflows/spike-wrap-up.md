...
`./.antigravitycli/skills/spike-findings-[project]/` (project-local) and summary to
...
3. Check if `./.antigravitycli/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.antigravitycli/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.antigravitycli/skills/spike-findings-[project]/`
...
**Processed:** {N} spikes
**Feature areas:** {list}
**Skill:** `./.antigravitycli/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.antigravitycli/skills/` with SKILL.md (including requirements), references/, sources/
