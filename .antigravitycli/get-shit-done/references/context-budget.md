...
The keys live in `.claude/settings.json` (project) or `/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.antigravitycli/settings.json` (global) — **not** in `.planning/config.json`:
