...
- **Check Current Profile:**
  ```bash
  node .gemini/get-shit-done/bin/gsd-tools.cjs config-get model_profile
  ```
- **Set Quality Profile (Recommended):**
  ```bash
  node .gemini/get-shit-done/bin/gsd-tools.cjs config-set model_profile quality
  ```
- **Inherit Session Model:**
  ```bash
  node .gemini/get-shit-done/bin/gsd-tools.cjs config-set model_profile inherit
  ```
- **Advanced Overrides:** 
