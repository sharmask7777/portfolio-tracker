...
## Phase 17: Unified Setup & Automation [COMPLETED]
**Goal:** Simplify the onboarding process and automate database lifecycle.

**Plans:** 2 plans
- [x] 17-01-PLAN.md — Unified environment setup script (setup.sh)
- [x] 17-02-PLAN.md — Automatic migrations & one-command start
