...
- Usage: Reference from command with `@/Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/shaleensharma/workplace/gemini_ws/portfolio-tracker/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
